...
class GPGPUParticle {
    ...
    private offsetValueShader:any;
    private computeShaderPosition:any;
    private computeShaderVelocity:any;
    private particleShader:any;
    ...
    private fillTextures(dtPosition, dtVelocity,dtOffset)
    {
